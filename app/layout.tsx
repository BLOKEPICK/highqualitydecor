...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'High Quality Decor', description: 'Elegant, family-first event decor across the United States.', url: 'https://highqualitydecor.com', siteName: 'High Quality Decor', images:[{url:'/og-image.jpg',width:1200,height:630}], locale:'en_US', type:'website' },
  alternates: { canonical: 'https://highqualitydecor.com' }
};

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (<html lang="en"><body><Navbar />{children}<Footer /><WhatsAppButton /></body></html>);
}
