...
export default function HomePage(){
  return (<main>
    <section className="hero"><div className="container">
      ...
      <p>Flowers, decor, films and design—crafted with love for the moments that matter.</p>
      <div className="cta"><Link href="/contact" className="btn btn-primary">Get a Quote</Link><Link href="/portfolio" className="btn btn-outline">See Portfolio</Link></div>
    </div></section>

    <section className="section"><div className="container">
      <div className="grid cols-3">
        <div className="highlight"><h3>Signature Florals</h3><p>Romantic lilacs, modern black & white, or lush garden vibes—our florals fit your story.</p></div>
        <div className="highlight"><h3>Decor & Ambience</h3><p>Backdrops, tablescapes, lighting and all the little details guests remember.</p></div>
        <div className="highlight"><h3>Film & Design</h3><p>Photo/video to relive the day—plus invitations that set the tone.</p></div>
      </div>
    </div></section>

    <section className="section"><div className="container">
      <h2>What we do</h2><p className="subtitle">From intimate surprises to grand ceremonies—nationwide.</p>
      <div className="grid cols-3">
    ...
    <section className="section"><div className="container">
      <h2>Popular packages</h2><p className="subtitle">Clear options you can tailor to your date and venue.</p><Packages/>
    </div></section>

    <section className="section"><div className="container grid cols-2">
