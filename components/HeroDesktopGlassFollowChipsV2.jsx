...
/**
 * HeroDesktopGlassFollowChipsV2 — Fixed chips + inline socials
 * - Desktop/tablet only. Use via HeroSwitch or a desktop wrapper.
 * - Chips are rebuilt with consistent desktop styling (small pill cards, svg + label).
 * - Social icons are the exact anchors from Header.jsx (clickable).
 */
export default function HeroDesktopGlassFollowChipsV2() {
  return (
    <section className="hero-glass" aria-label="High Quality Decor — Hero">
      ...
      <style jsx>{`
        ...
        /* Desktop chip pills (consistent sizing) */
