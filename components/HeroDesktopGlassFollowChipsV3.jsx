...
/**
 * HeroDesktopGlassFollowChipsV3 — Desktop hero (patched)
 * - Usa EXACTAMENTE los SVG del menú hamburguesa (copiados de Header.jsx dentro de .socials)
 * - En una sola línea y con espacio entre el label y el bloque de iconos.
 * - NO modificamos los <svg width="22" height="22"> ni sus clases.
 */
  ...
  return (
    <section className="hero-glass" aria-label="High Quality Decor — Hero">
          ...
          <div className="cta-row">
            ...
            <div className="social-inline" aria-label="Follow us">
              ...
              <div className="icons">
                ...
                <svg width="22" height="22" role="img" viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6">
      ...
      <style jsx>{`
        ...
        /* Solo disposición: una línea + espacio. NO tocamos los <svg width="22" height="22"> internos. */
