...
/**
 * HeroDesktopGlassFollowChipsV3 — Desktop hero with inline socials & fixed-size chips
 * - Reuses the SAME social anchors SVGs from Header (if found), with inline sizing to avoid flashes.
 * - Chips pills (svg 16px + label) consistent for desktop.
 */
export default function HeroDesktopGlassFollowChipsV3() {
  return (
    <section className="hero-glass" aria-label="High Quality Decor — Hero">
          ...
          <div className="cta-row">
            ...
            <div className="social-inline" aria-label="Follow us">
              ...
              <span className="icons">
                <a href="#" aria-label="Instagram"><span className="sr-only">Instagram</span><svg width="22" height="22" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="5" stroke="currentColor"/><circle cx="12" cy="12" r="4" stroke="currentColor"/><circle cx="17.5" cy="6.5" r="1.25" fill="currentColor"/></svg></a>
                <a href="#" aria-label="Facebook"><span className="sr-only">Facebook</span><svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M14 9h3V6h-3a4 4 0 0 0-4 4v3H7v3h3v6h3v-6h3l1-3h-4v-3a1 1 0 0 1 1-1Z" fill="currentColor"/></svg></a>
              </span>
            </div>
          </div>
      ...
      <style jsx>{`
        ...
        .social-inline { display: inline-flex; align-items: center; gap: 14px; white-space: nowrap; }
