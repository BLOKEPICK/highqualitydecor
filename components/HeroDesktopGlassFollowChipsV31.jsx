"use client";
import { HeaderSocials } from "./Header"; // <-- requiere export nombrado desde Header.jsx

export default function HeroDesktopGlassFollowChipsV31() {
  return (
    <section className="hero-glass" aria-label="High Quality Decor — Hero">
      ...
      <div className="container">
        <div className="card">
          ...
          <div className="cta-row">
            ...
            {/* Reutilizamos EXACTAMENTE los iconos del Header (mismo SVG) */}
      ...
      <style jsx>{`
        ...
        /* En una sola línea y con espacio entre iconos */
