...
export default function Header() {
  ...
  return (
    <header className="site-header" role="banner">
      <div className="container header-inner header-3col">
        ...
        <div className="header-col center">
          <nav className="main-nav desktop centered" aria-label="Main navigation">
            <Link className="nav-item" href="/#services"><span className="label">Services</span></Link>
            <Link className="nav-item" href="/#about"><span className="label">About Us</span></Link>
            <Link className="nav-item" href="/#gallery"><span className="label">Gallery</span></Link>
            <Link className="nav-item" href="/#contact"><span className="label">Contact</span></Link>
          </nav>
        </div>
      ...
      {/* Mobile Panel */}
      <Portal>
        <div className={`backdrop blur ${open ? "open" : ""}`} role="dialog" aria-modal="true" onClick={(e)=>{ if (e.target === e.currentTarget) close(); }}>
